...
locals {
  payment_tag = data.aws_secretsmanager_secret_version.payment_tag_val.secret_string
}
...
locals {
  kitchen_tag = data.aws_secretsmanager_secret_version.kitchen_tag_val.secret_string
}
...
locals {
  order_tag = data.aws_secretsmanager_secret_version.order_tag_val.secret_string
}
